...
export const visaRequirements: CountryVisaStatus[] = [
  ...
  { country: 'Thailand', countryCode: 'TH', visaRequired: true, category: 'VISA_REQUIRED', description: 'Visa required' },
  ...
  { country: 'Mauritius', countryCode: 'MU', visaRequired: true, category: 'VISA_REQUIRED', description: 'Visa required' },
  { country: 'Seychelles', countryCode: 'SC', visaRequired: true, category: 'VISA_REQUIRED', description: 'Visa required' },
  ...
  { country: 'Costa Rica', countryCode: 'CR', visaRequired: true, category: 'VISA_REQUIRED', description: 'Visa required' },
  { country: 'Panama', countryCode: 'PA', visaRequired: true, category: 'VISA_REQUIRED', description: 'Visa required' },
  { country: 'Colombia', countryCode: 'CO', visaRequired: true, category: 'VISA_REQUIRED', description: 'Visa required' },
  { country: 'Venezuela', countryCode: 'VE', visaRequired: true, category: 'VISA_REQUIRED', description: 'Visa required' },
  { country: 'Ecuador', countryCode: 'EC', visaRequired: true, category: 'VISA_REQUIRED', description: 'Visa required' },
  { country: 'Peru', countryCode: 'PE', visaRequired: true, category: 'VISA_REQUIRED', description: 'Visa required' },
