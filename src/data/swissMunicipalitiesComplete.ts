// Complete Swiss municipalities data for fast local search
...
export const SWISS_MUNICIPALITIES: MunicipalityData[] = [
...
export function searchMunicipalities(query: string, limit: number = 20): MunicipalityData[] {
  if (!query || query.length < 1) return []
  
  const lowercaseQuery = query.toLowerCase()
  
  return SWISS_MUNICIPALITIES.filter(municipality => 
