-- ============================================================================
-- UPDATE get_user_tasks FUNCTION FOR TASK 3 FEATURES
-- ============================================================================

-- Drop the existing function
DROP FUNCTION IF EXISTS public.get_user_tasks(UUID, INTEGER);

-- Create the function with all Task 3 fields
...
RETURNS TABLE (
  ...
  modal_has_pdf_upload BOOLEAN,  -- ADD THIS FIELD
  modal_has_school_email_generator BOOLEAN,  -- ADD THIS FIELD
...
BEGIN
  ...
  SELECT 
    ...
    COALESCE(tv.modal_has_pdf_upload, false) as modal_has_pdf_upload,  -- ADD THIS LINE
    COALESCE(tv.modal_has_school_email_generator, false) as modal_has_school_email_generator,  -- ADD THIS LINE
...
-- Test the function
SELECT 'FUNCTION UPDATED:' as status, 'modal_has_pdf_upload and modal_has_school_email_generator fields added' as message;
