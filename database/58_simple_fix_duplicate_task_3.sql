-- ============================================================================
-- SIMPLE FIX FOR DUPLICATE TASK 3 - NO COMPLEX SEGMENTATION
-- ============================================================================

-- Drop the existing function
DROP FUNCTION IF EXISTS public.get_user_tasks(UUID, INTEGER);

-- Create a simple function that shows only one variant per task
...
-- Test the function
SELECT 'SIMPLE FUNCTION UPDATED:' as status, 'Now shows only one variant per task without complex segmentation' as message;
