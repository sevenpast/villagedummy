-- ============================================================================
-- DSGVO/GDPR COMPLIANCE SYSTEM - SIMPLIFIED VERSION
-- PostgreSQL 15+ with Supabase
-- Works without Document Vault tables
-- ============================================================================
...
-- Get all user data for export (DSGVO Art. 20) - Simplified version
...
BEGIN
    ...
    result := jsonb_build_object(
        'export_info', jsonb_build_object(
            'exported_at', NOW(),
            'user_id', user_uuid,
            'data_categories', ARRAY['personal_data', 'task_progress', 'consents', 'privacy_settings', 'legal_acceptances'],
            'legal_basis', 'consent',
...
-- Soft delete user data (DSGVO Art. 17 - Right to Erasure) - Simplified version
...
(
    ...
    'Tracking user progress through onboarding tasks',
    'legitimate_interest',
    ARRAY['usage_data', 'progress_data'],
    ARRAY['users'],
    ARRAY['supabase'],
    ARRAY['usa'],
    '2_years',
