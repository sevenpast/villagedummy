-- ============================================================================
-- FINAL FIX FOR DUPLICATE get_user_tasks FUNCTIONS
-- ============================================================================
...
-- Drop ALL existing get_user_tasks functions by OID to be absolutely sure
DO $$
DECLARE
    func_oid OID;
BEGIN
    FOR func_oid IN 
        ...
        AND pronamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'public')
    LOOP
        EXECUTE 'DROP FUNCTION IF EXISTS ' || func_oid::regproc;
