-- ============================================================================
-- UPDATE TASK 3 VISA_REQUIRED VARIANT
-- ============================================================================

-- Update Task 3 visa_required variant with new content
...
-Proof of health insurance (or provide it within 3 months)',
  ...
  modal_content = 'Website + checklist & note + PDF upload',
...
-- Verify the update
SELECT
  'Task 3 visa_required Update Verification:' as info,
  t.task_number,
...
AND tv.variant_name = 'visa_required';
