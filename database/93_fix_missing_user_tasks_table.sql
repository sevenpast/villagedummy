-- ============================================================================
-- FIX get_user_tasks FUNCTION WITHOUT user_tasks TABLE
-- ============================================================================

-- Drop the existing function
DROP FUNCTION IF EXISTS public.get_user_tasks(UUID);

-- Create a simplified get_user_tasks function that doesn't rely on user_tasks table
...
SELECT 
  'Test get_user_tasks function (without user_tasks table):' as info,
  task_number,
  variant_name,
  question_text,
  actions,
